    ...
    return (
        <section id="seja-bem-vindo" className="grid grid-cols-12 gap-8  items-start justify-center md:justify-start h-auto 2xl:max-w-[1900px] mx-auto px-[120px] relative z-10 mb-[250px]">
            <Image
                ...
                width={800}
                height={800}
                className="w-[800px] hidden sm:block h-auto absolute top-1/2 left-0 transform md:-translate-x-36 -translate-x-6 lg:-translate-y-[270px] -translate-y-[100px] z-1"
            />
            <Image
                src="/images/bg/background-esquerdo.webp"
                alt="logo"
            ...
            <div className="col-span-12 mt-16 w-full text-center md:text-left sm:text-center">
                <h1 className="text-3xl lg:text-2xl font-normal">Seja bem-vindo ao</h1>
                <h2 className="lg:text-9xl sm:text-7xl  xl:text-10xl text-6xl font-[800]  mb-1 uppercase h-auto md:mt-[-30px] lg:mt-[-40px]">Instituto do</h2>
                <h3 className="text-8xl sm:text-11xl md:mt-[-80px] lg:text-17xl lg:mt-[-150px] xl:text-17xl lg:mt-[-100px] font-[800] mt-[-40px] mb-4 uppercase text-primary">sabor</h3>

    ...
    return (
        <>
            ...
            >
                ...
                <div className="2xl:max-w-[1900px] mx-auto px-[120px] col-span-12">
                    <Image
                        src="/images/bg/background-esquerdo.webp"
                        alt="logo"
                        width={800}
                        height={800}
                        className="w-[800px] hidden lg:block h-auto absolute top-1/2 left-0 transform md:-translate-x-36 -translate-x-6 2xl:-translate-x-[10px] lg:-translate-y-[270px]  -translate-y-[100px] z-1"
                    />
                    <Image
                        src="/images/bg/background-esquerdo.webp"
                        alt="logo"
                        width={400}
                        height={400}
                        className="hidden 2xl:block absolute left-0 top-1/2 transform -translate-x-[-500px] 2xl:-translate-x-[10px] -translate-y-[-40px] rotate-[-125deg] z-1"
                    />
                    <Image
                        src="/images/bg/background-esquerdo.webp"
                        alt="logo"
                        width={200}
                        height={200}
                        className="hidden 2xl:block absolute left-0 top-1/2 transform -translate-x-[-990px] 2xl:-translate-x-[-520px] -translate-y-[300px] rotate-[160deg] scale-x-[-1] z-1"
                    />

                    <div className="col-span-12 mt-16 w-full text-center 

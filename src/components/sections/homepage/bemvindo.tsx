            ...
            >
                ...
                <div className="2xl:max-w-[1900px] mx-auto px-[120px] col-span-6 3xl:col-span-12 hidden">
                    ...
                    <div className="col-span-12 mt-16 w-full text-center 
                        ...
                        <h2 className="lg:text-9xl sm:text-[3rem] md:text-[4rem] xl:text-[6.8rem] 3xl:text-[7.5rem] text-6xl font-[800]  mb-1 uppercase h-auto md:mt-[-30px] lg:mt-[-40px]">Instituto do</h2>
                        <h3 className="text-8xl sm:text-[7rem] md:text-[9rem] md:mt-[-80px] lg:text-17xl lg:mt-[-150px] xl:text-17xl 3xl:text-[16rem] lg:mt-[-100px] font-[800] mt-[-40px] mb-4 uppercase text-primary">sabor</h3>

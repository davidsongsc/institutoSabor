...
const TransformeCarreira: React.FC = () => {
    ...
    return (
        <section
            ...
            <div
                className="relative z-10 col-span-12 grid
                        grid-cols-12 lg:h-[700px] items-center
                         justify-center ">

                <span
                    className="col-span-5 2xl:col-span-5
                             hidden lg:block ">
                    <Image
                ...
                <div
                    className="sm:col-span-12 2xl:col-span-7
                    col-span-12  justify-self-center relative
                    px-4 z-10 transform 2xl:-translate-x-[110px]">

                    <div
                        className=" justify-self-start">
                        <h1
                            className="bg-primary text-[1rem] 
                         text-secondary sm:text-[1.8rem]
                         sm:text-[1.9rem] uppercase text-center
                          font-[800] mb-1 px-4 py-2 rounded">
                            Transformamos sua paixão pela
                        </h1>
                        <h2
                            className="mt-2 bg-quaternary text-primary
                            text-[1rem] sm:text-[1.7rem] sm:text-[1.8rem]
                            uppercase font-[800] px-4 py-2 rounded
                    ...
                    <div
                        className=" justify-self-start pt-4 Nexa
                        relative z-10 bg-quinary sm:bg-transparent
                        xl:bg-quinary 2xl:bg-transparent xl:p-8 
                        2xl:p-0 xl:rounded-[20px] ">

                        <p
                            className="mt-5 text-[0.7rem]
                            sm:text-[1.2rem] md:text-[1.4rem]">
                        ...
                        <p
                            className="text-[0.7rem]
                            sm:text-[1.2rem] md:text-[1.4rem]">
                            para os desafios do mundo gastronômico.
                            <span className="font-bold">Junte-se a nós e</span>
                        </p>
                        <p
                            className="text-[0.7rem] sm:text-[1.2rem]
                            md:text-[1.4rem]">
                        ...
                        <Button
                            type="primary"
                            size="large"
                            className="uppercase mt-8 text-2xl p-8 Nexa"
                            onClick={() => {
